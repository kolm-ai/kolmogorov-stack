...
const REPLACEMENTS = [
  ...
  [/\bbrew install kolm\b/g, 'npm i -g github:kolm-ai/kolm'],
  [/\bpip install kolm\b/g, 'npm i -g github:kolm-ai/kolm'],
  [/curl -fsSL https:\/\/kolm\.ai\/install/g, 'npm i -g github:kolm-ai/kolm'],

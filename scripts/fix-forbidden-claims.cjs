...
const REPLACEMENTS = [
  ...
  [/\bbrew install kolm\b/g, 'npm i -g github:sneaky-hippo/kolm-stack'],
  [/\bpip install kolm\b/g, 'npm i -g github:sneaky-hippo/kolm-stack'],
  [/curl -fsSL https:\/\/kolm\.ai\/install/g, 'npm i -g github:sneaky-hippo/kolm-stack'],

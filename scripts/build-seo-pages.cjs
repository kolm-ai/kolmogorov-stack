...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "totalTime": "PT5M",
      "step": [
        { "@type": "HowToStep", "position": 1, "name": "Install kolm", "text": "Install the kolm CLI from source: pip install git+https://github.com/sneaky-hippo/kolmogorov-stack@main#subdirectory=sdk/python or npm i -g github:sneaky-hippo/kolm-stack." },
...
<style>
:root{--ink:#e6e9ee;--ink-mute:#9aa3b2;--ink-faint:#6b7280;--bg:#0b0d10;--bg-elev:#11151b;--accent:#5eead4;--line:rgba(230,233,238,.10);--mono:ui-monospace,'SF Mono',Menlo,Consolas,monospace;--sans:-apple-system,BlinkMacSystemFont,'SF Pro Display','Inter','Segoe UI',system-ui,sans-serif}
...
.badge-grounded{color:var(--accent);border-color:rgba(94,234,212,.4)}
.badge-est{color:var(--ink-mute)}
.muted{color:var(--ink-faint)}
.cta{display:inline-block;background:var(--accent);color:#0b0d10;padding:11px 22px;border-radius:8px;font-weight:600;font-family:var(--mono);font-size:14px;margin:8px 12px 8px 0}.cta:hover{text-decoration:none;background:#7eebd3}
.cta-alt{display:inline-block;background:transparent;color:var(--accent);border:1px solid var(--accent);padding:10px 22px;border-radius:8px;font-weight:600;font-family:var(--mono);font-size:14px;margin:8px 12px 8px 0}.cta-alt:hover{text-decoration:none;background:rgba(94,234,212,.08)}
...
<h2>Step-by-step</h2>
<ol>
  <li><strong>Install kolm.</strong> <code>npm i -g github:sneaky-hippo/kolm-stack</code> or <code>pip install git+https://github.com/sneaky-hippo/kolmogorov-stack@main#subdirectory=sdk/python</code>.</li>
...
<ul>
  ...
  <li><strong>Open source.</strong> Apache-2.0. <a href="https://github.com/sneaky-hippo/kolmogorov-stack" rel="noopener">GitHub</a>.</li>
</ul>

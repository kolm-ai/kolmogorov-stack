...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
      ...
      "totalTime": "PT5M",
      "step": [
        { "@type": "HowToStep", "position": 1, "name": "Install kolm", "text": "Install the kolm CLI from source: pip install git+https://github.com/kolm-ai/kolm@main#subdirectory=sdk/python or npm i -g github:sneaky-hippo/kolm-stack." },
...
<h2>Step-by-step</h2>
<ol>
  <li><strong>Install kolm.</strong> <code>npm i -g github:sneaky-hippo/kolm-stack</code> or <code>pip install git+https://github.com/kolm-ai/kolm@main#subdirectory=sdk/python</code>.</li>

...
const CANONICAL = `<footer class="site-footer">
  <div class="wrap">
    ...
    <small class="footer-tag">
      <a href="/trust">trust</a> &middot; <a href="/security">security</a> &middot; <a href="/privacy">privacy</a> &middot; <a href="/terms">terms</a> &middot; <a href="/faq">faq</a> &middot; <a href="https://github.com/sneaky-hippo/kolmogorov-stack">github</a> &middot; kolm.ai &middot; MIT licensed runtime
    </small>
  </div>
</footer>`;

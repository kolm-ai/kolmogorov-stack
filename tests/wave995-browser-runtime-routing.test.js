...
test('W995 stack spec closes routing and later runners close browser GGUF execution', () => {
  ...
  assert.doesNotMatch(spec, /\[major\] LlamaWeb GGUF execution remains unwired/);
});

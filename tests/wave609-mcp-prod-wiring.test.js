...
test('1b. backend spec records MCP closures and leaves transcript continuity open', () => {
  ...
  assert.match(spec, /Full MCP session transcript continuity is still not first-class/i);

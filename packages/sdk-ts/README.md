...
The surface mirrors the Python SDK (`packages/sdk-python`). If a method exists there and not here, that is a bug. File it at https://github.com/kolm-ai/kolm/issues.

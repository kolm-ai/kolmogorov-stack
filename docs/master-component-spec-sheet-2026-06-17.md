...
Generated 2026-06-17. Source of truth: `docs/backend-atomic-component-deep-dive-2026-06-17.json`, `docs/whole-stack-sota-deep-dive-2026-06-17.json`, `docs/product-sota-readiness.json`, and `docs/internal/frontier-delta-freshness.json`.
...
- Atomic components inventoried: **984**
- Atomic deep dives complete: **100%**
- Direct test referenced: **984/984 (100%)**
...
- Readiness proof surplus hill-climb: **105.8/110**
...
- Frontier delta authority: **current_spec_verified** (15 historical severe categories superseded; 0 current severe categories)
...
| finetune-frameworks | training | sota_review_complete_external_or_release_gate_open | at=14 open=0/0/0 | 3 | npm run verify:stack-sota<br>npm run verify:inventions |
| synthetic-data-curation | data | sota_review_complete_local_frontier_aligned | at=10 open=0/0/0 | 3 | npm run verify:stack-sota<br>npm run verify:redaction-benchmark |
...
| ondevice-inference | cross-device | sota_review_complete_external_or_release_gate_open | at=11 open=0/0/0 | 3 | npm run verify:stack-sota<br>npm run verify:platform |
...
| verifiable-inference | trust | sota_review_complete_external_or_release_gate_open | at=16 open=0/0/0 | 5 | npm run verify:stack-sota<br>npm run verify:compliance-packet |
| model-signing-standards | trust | sota_review_complete_external_or_release_gate_open | at=11 open=0/0/0 | 4 | npm run verify:stack-sota<br>npm run verify:compliance-packet |
| confidential-compute | enterprise | sota_review_complete_external_or_release_gate_open | at=10 open=0/0/0 | 4 | npm run verify:stack-sota<br>npm run verify:compliance-packet |
| agent-security-eval | enterprise | sota_review_complete_external_or_release_gate_open | at=8 open=0/0/0 | 4 | npm run verify:stack-sota<br>npm run verify:compliance-packet |
| compile-api-to-model-competitors | compiler-platform | sota_review_complete_external_or_release_gate_open | at=13 open=0/0/0 | 4 | npm run verify:stack-sota<br>npm run verify:inventions |

...
| verifiable-inference | trust | sota_review_complete_critical_frontier_work_open | at=14 open=1/0/1 | 5 | npm run verify:stack-sota<br>npm run verify:compliance-packet |

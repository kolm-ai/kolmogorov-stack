...
| small-llm-students | model-registry | sota_review_complete_critical_frontier_work_open | at=10 open=1/0/1 | 3 | npm run verify:stack-sota<br>npm run verify:inventions |

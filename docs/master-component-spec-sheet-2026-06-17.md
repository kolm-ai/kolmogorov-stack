...
| mcp-tool-gateway-receipts | agent-integrations | sota_review_complete_external_or_release_gate_open | at=14 open=0/0/1 | 3 | npm run verify:stack-sota<br>npm run verify:governance-packets |

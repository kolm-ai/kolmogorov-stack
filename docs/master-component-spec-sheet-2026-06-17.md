...
- Local engineering perfection: **88.7/100**
...
- High-priority direct test referenced: **42/47 (89.4%)**
...
| --- | --- | --- | --- | --- | --- |
| distillation | training | sota_review_complete_critical_frontier_work_open | at=10 open=1/0/2 | 3 | npm run verify:stack-sota<br>npm run verify:inventions |
...
| quantization | compiler-runtime | sota_review_complete_major_frontier_work_open | at=9 open=0/5/1 | 3 | npm run verify:stack-sota<br>npm run verify:quant-oracle |
...
| speculative-decoding | runtime | sota_review_complete_critical_frontier_work_open | at=6 open=1/2/3 | 3 | npm run verify:stack-sota<br>npm run verify:surfaces |
| finetune-frameworks | training | sota_review_complete_major_frontier_work_open | at=9 open=0/2/4 | 3 | npm run verify:stack-sota<br>npm run verify:inventions |
...
| verifiable-inference | trust | sota_review_complete_critical_frontier_work_open | at=8 open=2/1/2 | 4 | npm run verify:stack-sota<br>npm run verify:compliance-packet |
...
| confidential-compute | enterprise | sota_review_complete_critical_frontier_work_open | at=7 open=1/3/2 | 4 | npm run verify:stack-sota<br>npm run verify:compliance-packet |
| agent-security-eval | enterprise | sota_review_complete_critical_frontier_work_open | at=6 open=1/4/2 | 3 | npm run verify:stack-sota<br>npm run verify:compliance-packet |
...
| `src/marketplace-routes.js` | api_surface | 8 | direct_test_reference_missing<br>high_priority_direct_test_missing<br>linked_frontier_work_open | Add a direct contract/security/regression test before expanding this component. |

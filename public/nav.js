...
installSurfaceGuard();
  ...
  (function injectSiteChrome() {
    var NAV_HTML = [
      ...
      '<a href="/start">Start</a><a href="/wrapper">Wrapper</a><a href="/studio">Studio</a><a href="/pricing">Pricing</a><a href="/docs">Docs</a><a href="https://github.com/kolm-ai/kolm" rel="noopener">GitHub</a><a href="/signup?intent=login">Sign in</a><a href="/signup">Get started &rarr;</a>',
      '</div>',
      '</div>'
    ].join('');
    var FOOTER_HTML = [

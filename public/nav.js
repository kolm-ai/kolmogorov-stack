...
installSurfaceGuard();
  ...
  // had its own pre-baked <nav class="ks-nav">.
  // Source-of-truth markup mirrors wrapper.html / studio.html exactly.
  (function injectSiteChrome() {
    var NAV_HTML = [
      '<div class="ks-nav-wrap">',
      '<nav class="ks-nav" aria-label="Primary">',
      '<a href="/" class="ks-nav__brand" aria-label="kolm.ai: the AI control plane for teams"><span class="ks-nav__mark" aria-hidden="true"><svg viewBox="0 0 32 32" fill="none" role="img" aria-label="kolm"><rect x="4" y="6" width="4.5" height="20" rx="0.4"/><rect x="13" y="9" width="4.5" height="14" rx="0.4"/><rect x="22" y="12" width="4.5" height="8" rx="0.4"/></svg></span><span>kolm<b>.ai</b></span></a>',
      ...
      '<a href="/start">Start</a><a href="/product">Product</a><a href="/solutions/teams">For teams</a><a href="/pricing">Pricing</a><a href="/docs">Docs</a><a href="/enterprise">Enterprise</a><a href="/signup?intent=login">Sign in</a><a href="/signup">Get started &rarr;</a>',
      '</div>',
      '</div>'
    ].join('');
    var FOOTER_HTML = [
      ...
      '<div>',
      '<a href="/" class="ks-nav__brand" aria-label="kolm.ai: the AI control plane for teams"><span class="ks-nav__mark" aria-hidden="true"><svg viewBox="0 0 32 32" fill="none" role="img" aria-label="kolm"><rect x="4" y="6" width="4.5" height="20" rx="0.4"/><rect x="13" y="9" width="4.5" height="14" rx="0.4"/><rect x="22" y="12" width="4.5" height="8" rx="0.4"/></svg></span><span>kolm<b>.ai</b></span></a>',
      '<p class="ks-footer__tagline">The AI control plane for teams.</p>',
      '</div>',
      '<div>',
      '<h4>Product</h4>',
      '<ul><li><a href="/product">Overview</a></li><li><a href="/capture">Capture</a></li><li><a href="/security">Security &amp; receipts</a></li><li><a href="/integrations">Integrations</a></li><li><a href="/docs/api">API reference</a></li></ul>',
      '</div>',
      '<div>',
      '<h4>Build</h4>',
      '<ul><li><a href="/studio">Overview</a></li><li><a href="/distill">Distill</a></li><li><a href="/compile">Compile</a></li><li><a href="/k-score">k-score</a></li><li><a href="/models">Models</a></li><li><a href="/spec/toml">.kolm spec</a></li></ul>',
      '</div>',
      '<div>',
      '<h4>Company</h4>',
      '<ul><li><a href="/start">Get started</a></li><li><a href="/pricing">Pricing</a></li><li><a href="/docs">Docs</a></li><li><a href="/about">About</a></li><li><a href="/changelog">Changelog</a></li></ul>',
      '</div>',
      '</div>',
    ...
    try {
      var navSlots = document.querySelectorAll('div[data-include-nav]');
      for (var i = 0; i < navSlots.length; i++) {
        if (!navSlots[i].firstElementChild) navSlots[i].innerHTML = NAV_HTML;
      }
      var footerSlots = document.querySelectorAll('div[data-include-footer]');
      for (var j = 0; j < footerSlots.length; j++) {
        if (!footerSlots[j].firstElementChild) footerSlots[j].innerHTML = FOOTER_HTML;
      }
    } catch (e) {}
  })();

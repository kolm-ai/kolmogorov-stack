...
export const MODEL_FRAMEWORK_TARGETS = Object.freeze([
  ...
  },
  {
    ...
    env: [],
    evidence: ['public/sdk.js', 'public/device/webgpu-runner.js', 'public/device/onnx-web-runner.js', 'public/device/webllm-runner.js', 'public/device/llamaweb-runner.js', 'public/device/fixtures/tiny-linear.manifest.json', 'server.js', 'docs/kolm-format-v1.md'],
    status: 'implemented',
    note: 'Browser SDK/WASM support exists, public/device/webgpu-runner.js verifies signed weight bytes before executing a tiny WebGPU-or-CPU model fixture, public/device/onnx-web-runner.js runs signed ONNX bytes through an explicit onnxruntime-web/WebGPU adapter, public/device/webllm-runner.js runs signed WebLLM/MLC bytes through an explicit byte-loading bridge before chat, and public/device/llamaweb-runner.js runs signed GGUF bytes through an explicit LlamaWeb byte-loading bridge before generation.',
  },
  {
    id: 'vllm',
...
export const MODEL_FAMILY_TARGETS = Object.freeze([
  ...
  { id: 'audio-voiceprint-model', class: 'media', modalities: ['audio'], evidence: ['cli/kolm.js', 'public/account/train.html'], status: 'dependency-gated' },
...
export const DEVICE_TARGETS = Object.freeze([
  ...
  { id: 'browser-webgpu', class: 'browser', runtimes: ['webgpu', 'wasm', 'onnxruntime-web', 'webllm', 'llama.cpp-webgpu'], evidence: ['public/device/webgpu-runner.js', 'public/device/onnx-web-runner.js', 'public/device/webllm-runner.js', 'public/device/llamaweb-runner.js', 'public/device/webgpu-runner.html', 'public/device/fixtures/tiny-linear.manifest.json', 'public/sdk.js', 'docs/product-surfaces.json'], status: 'implemented' },
...
export const DEPLOYMENT_PROFILES = Object.freeze([
  {
    ...
    account: ['/account/overview', '/account/train', '/account/dashboard'],
  ...
  },
  {
    ...
    account: ['/account/org', '/account/api-control-center'],
  ...
  },
  {
    ...
    account: ['/account/dashboard', '/account/train', '/account/overview'],
  ...
  },
  {
    ...
    account: ['/account/org', '/account/api-control-center', '/account/overview'],

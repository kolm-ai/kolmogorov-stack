...
export const MODEL_FRAMEWORK_TARGETS = Object.freeze([
  ...
  },
  {
    ...
    env: [],
    evidence: ['public/sdk.js', 'public/device/webgpu-runner.js', 'public/device/onnx-web-runner.js', 'public/device/webllm-runner.js', 'public/device/fixtures/tiny-linear.manifest.json', 'server.js', 'docs/kolm-format-v1.md'],
    status: 'implemented',
    note: 'Browser SDK/WASM support exists, public/device/webgpu-runner.js verifies signed weight bytes before executing a tiny WebGPU-or-CPU model fixture, public/device/onnx-web-runner.js runs signed ONNX bytes through an explicit onnxruntime-web/WebGPU adapter, and public/device/webllm-runner.js runs signed WebLLM/MLC bytes through an explicit byte-loading bridge before chat. LlamaWeb GGUF browser execution remains a separate target.',
  },
  {
    id: 'vllm',
...
export const DEVICE_TARGETS = Object.freeze([
  ...
  { id: 'browser-webgpu', class: 'browser', runtimes: ['webgpu', 'wasm', 'onnxruntime-web', 'webllm'], evidence: ['public/device/webgpu-runner.js', 'public/device/onnx-web-runner.js', 'public/device/webllm-runner.js', 'public/device/webgpu-runner.html', 'public/device/fixtures/tiny-linear.manifest.json', 'public/sdk.js', 'docs/product-surfaces.json'], status: 'implemented' },

...
export const PRODUCT_SURFACE_EXPERIENCE = Object.freeze([
  ...
  },
  {
    ...
    cli: ['kolm train --namespace <name>', 'kolm distill --namespace <name>', 'kolm cloud train <name> --seeds examples.jsonl', 'kolm pipeline full'],
    ...
    empty_state_action: 'Create a dataset or run `kolm cloud readiness --json` to configure hosted training.',
    status_fields: ['build_state', 'teacher_model', 'student_model', 'compute_target', 'k_score_gate'],
    evidence_paths: ['src/distill-pipeline.js', 'src/distill-onpolicy.js', 'src/distill-preference.js', 'src/spec-decode.js', 'src/remote-compute.js', 'public/account/builds.html', 'public/account/distill-runs.html'],
  ...
  },
  {
    ...
    cli: ['kolm compile --spec spec.json --out task.kolm', 'kolm verify task.kolm', 'kolm diff old.kolm new.kolm', 'kolm export task.kolm --target gguf --preview'],
    ...
    primary_action: 'Compile, verify, and export an artifact with target runtime and receipts.',
    ...
    evidence_paths: ['src/compile-pipeline.js', 'src/artifact.js', 'src/artifact-runner.js', 'src/export-provenance.js', 'src/artifact-dependency-graph.js', 'docs/kolm-format-v1.md', 'public/account/artifacts.html'],
  ...
  },
  {
    ...
    cli: ['kolm run task.kolm "input"', 'kolm serve --mcp --http', 'kolm chat-tui --model=kolm:task', 'kolm runtime targets'],
    ...
    evidence_paths: ['src/completions-api.js', 'src/runtime-policy.js', 'src/streaming-contract.js', 'public/sdk.js', 'public/tui.html', 'cli/kolm.js'],
  ...
  },
  {
    ...
    primary_action: 'Run the local or remote cloud readiness doctor and choose the cheapest compliant compute/storage/deployment profile.',
    ...
    evidence_paths: ['src/platform-capabilities.js', 'src/object-storage.js', 'src/deployment-plans.js', 'src/remote-compute.js', 'src/compute/registry.json', 'scripts/cloud-readiness.mjs', 'docs/cloud-product-readiness.md', 'public/account/storage.html'],
  ...
  },
  {
    ...
    evidence_paths: ['src/auth.js', 'src/keys.js', 'src/audit.js', 'src/team-capture-rbac.js', 'src/router.js', 'public/account/api-keys.html', 'public/account/audit-log.html', 'public/account/billing.html'],

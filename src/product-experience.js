...
export const PRODUCT_SURFACE_EXPERIENCE = Object.freeze([
  {
    ...
    account: ['/account/overview', '/account/api-control-center'],
    ...
    evidence_paths: ['src/router.js', 'src/daemon-connector.js', 'src/completions-api.js', 'src/team-capture-rbac.js', 'public/account/overview.html', 'public/account/api-control-center.html'],
  ...
  },
  {
    ...
    evidence_paths: ['src/lake.js', 'src/privacy-membrane.js', 'src/event-store.js', 'src/event-schema.js', 'public/account/overview.html', 'public/account/api-control-center.html'],
  ...
  },
  {
    ...
    account: ['/account/train', '/account/overview'],
    cli: ['kolm dataset candidates --json', 'kolm label next --json', 'kolm dataset split <id>', 'kolm sim generate-dataset <id>'],
    tui: ['opportunities', 'labeling-queue', 'datasets', 'bakeoffs', 'lingual-manifest'],
    ...
    evidence_paths: ['src/dataset-workbench.js', 'src/simulation.js', 'src/router.js', 'public/account/train.html', 'public/account/overview.html'],
  ...
  },
  {
    ...
    tui: ['builds', 'multimodal-bakeoff', 'compile', 'pipeline-orchestrator', 'ab-experiments', 'token-dpo', 'reasoning-distill'],
    ...
    evidence_paths: ['src/distill-pipeline.js', 'src/distill-strategy.js', 'src/benchmark-evidence.js', 'src/distill-onpolicy.js', 'src/distill-preference.js', 'src/spec-decode.js', 'src/remote-compute.js', 'scripts/distill-strategy.mjs', 'scripts/benchmark-evidence.mjs', 'public/account/train.html', 'public/account/overview.html'],
  ...
  },
  {
    ...
    evidence_paths: ['src/models.js', 'src/model-registry.js', 'src/model-weights-manifest.js', 'public/account/train.html', 'tests/wave409rs-models-devices.test.js'],
  ...
  },
  {
    ...
    tui: ['multimodal-tokenize', 'multimodal-bakeoff', 'datasets', 'multimodal-pipeline'],
    ...
    evidence_paths: ['services/embed/multimodal.js', 'src/router.js', 'cli/kolm.js', 'public/account/train.html', 'tests/wave466-multimodal-bakeoff.test.js'],
  ...
  },
  {
    ...
    account: ['/account/overview', '/account/train'],
  ...
  },
  {
    ...
    tui: ['live-calls', 'artifacts', 'devices', 'k8s-readiness', 'runtime-placement'],
    ...
    evidence_paths: ['src/completions-api.js', 'src/runtime-policy.js', 'src/streaming-contract.js', 'src/package-release-readiness.js', 'src/runtime-adoption-packets.js', 'scripts/package-release-readiness.mjs', 'scripts/runtime-adoption-packets.mjs', 'public/sdk.js', 'public/account/overview.html', 'cli/kolm.js'],
  ...
  },
  {
    ...
    tui: ['devices', 'storage-sync', 'settings', 'savings-tracker'],
    ...
    evidence_paths: ['src/platform-capabilities.js', 'src/object-storage.js', 'src/cloud-compute-broker.js', 'src/deployment-plans.js', 'src/remote-compute.js', 'src/compute/registry.json', 'scripts/cloud-readiness.mjs', 'scripts/cloud-compute-broker.mjs', 'docs/cloud-product-readiness.md', 'public/account/train.html', 'public/account/overview.html'],
  ...
  },
  {
    ...
    account: ['/account/overview', '/account/dashboard'],
    ...
    tui: ['devices', 'storage-sync', 'airgap-jobs'],
    ...
    evidence_paths: ['src/device-capabilities.js', 'src/router.js', 'public/account/overview.html', 'public/account/dashboard.html', 'docs/kolm-format-v1.md'],
  ...
  },
  {
    ...
    account: ['/account/org', '/account/api-control-center', '/account-billing'],
    ...
    tui: ['audit-log', 'billing', 'settings', 'privacy-events', 'federated-consortium', 'regulatory-grc'],
    ...
    evidence_paths: ['src/auth.js', 'src/keys.js', 'src/audit.js', 'src/team-capture-rbac.js', 'src/compliance-certification-packet.js', 'src/router.js', 'scripts/compliance-certification-packet.mjs', 'public/account/org.html', 'public/account/api-control-center.html', 'public/account-billing.html'],
  ...
  },
  {
    ...
    account: ['/account/api-control-center', '/account/overview'],
    ...
    tui: ['agent-telemetry', 'artifacts', 'connectors', 'marketplace'],
    ...
    evidence_paths: ['services/mcp/server.js', 'src/repo-codegraph.js', 'src/publisher-verification.js', 'cli/kolm.js', 'public/account/api-control-center.html', 'public/account/overview.html'],

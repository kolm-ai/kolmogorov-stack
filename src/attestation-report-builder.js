...
export function buildRedTeamBlock(auditResult) {
  ...
  if (sum.benchmark_execution && typeof sum.benchmark_execution === 'object') {
    ...
    summary.benchmark_execution = {
      ...
      utility_under_attack_rate: b.utility_under_attack_rate == null ? null : Number(b.utility_under_attack_rate),
      utility_under_attack_tasks: Number.isFinite(b.utility_under_attack_tasks) ? b.utility_under_attack_tasks : 0,
      utility_under_attack_success: Number.isFinite(b.utility_under_attack_success) ? b.utility_under_attack_success : 0,
      paired_utility_tasks: Number.isFinite(b.paired_utility_tasks) ? b.paired_utility_tasks : 0,
      paired_utility_coverage: b.paired_utility_coverage == null ? null : Number(b.paired_utility_coverage),

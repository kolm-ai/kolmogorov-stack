...
export const CANDIDATE_MODELS = [
  ...
  },
  {
    ...
    ctx_k: 128,
    license: 'gemma-tou',
    modality_notes: 'Gemma 3 27B instruction model; official image+text input and 128K context.',
    source_url: 'https://huggingface.co/google',
    license_url: 'https://huggingface.co/google/gemma-3-27b-it/blob/main/LICENSE',
    revision_hash: null,
    revision_pinned: false,
    source_note: 'Google AI Gemma 3 docs reconciled 2026-05-20',
    verified_at: '2026-05-20',
    verification_evidence: evidence('Official Google Gemma 3 docs list 27B, image+text input, 128K context, and responsible commercial use; HF revision not pinned (warn-band).'),
    recipe_classes: ['rules', 'extraction', 'classification', 'agent', 'multimodal'],
  },
  {
  ...
  {
    id: 'google/gemma-3-12b-it-vulkan',
    family: 'gemma3',
    params: '12B',
    params_b: 12,
    active_params_b: 12,
    ...
    ctx_k: 128,
    license: 'gemma-tou',
    modality_notes: 'Gemma 3 12B instruction model candidate-listed for RX 9070 XT via Vulkan + ROCm.',
    source_url: 'https://huggingface.co/google',
    license_url: 'https://huggingface.co/google/gemma-3-12b-it/blob/main/LICENSE',
    revision_hash: null,
    revision_pinned: false,
    source_note: 'Google AI Gemma 3 docs reconciled 2026-05-20',
    verified_at: '2026-05-20',
    verification_evidence: evidence('Official Google Gemma 3 docs list 12B, image+text input, 128K context; exact device benchmark must be supplied before promotion.'),

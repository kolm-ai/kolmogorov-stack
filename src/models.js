...
export const MODELS = [
  ...
  },
  {
    ...
    family: 'minicpm5',
    params_b: 1.080632832,
    params_b_non_embedding: 0.679552512,
    license: 'apache-2.0',
    tier: 'edge-frontier-permissive',
    vram_gb_4bit: 1.1,
    vram_gb_bf16: 2.3,
    context_tokens: 131072,
    tool_use: 'native',
    ...
    architecture_features: [
      ...
      'SGLang minicpm5 tool-call parser',
      'FlagOS multi-chip release',
    ],
    frontier_student: true,
    benchmarks: {
      verified_at: '2026-06-19',
      source_url: 'https://raw.githubusercontent.com/OpenBMB/MiniCPM/main/assets/minicpm5/public_leaderboard_en.png',
      source_label: 'MiniCPM5 public leaderboard image linked from the Hugging Face model card',
      source_scope: 'exact_thinking_model_card_image_bfclv4',
      scale: 'percent_higher_is_better',
      metrics: {
        mmlu_pro: 48.85,
        ifeval: 80.41,
    ...
    notes: 'Apache 2.0 1B-class local assistant/coding-agent student. Use as the permissive edge default; LFM2.5 remains available when its license is acceptable and IFEval score is the main goal.',
    use_for: ['edge', 'edge-agent', 'laptop', 'classifier', 'extractor', 'agent', 'frontier-student'],
  },
  {
    ...
    params_b_raw: 5.1,
    license: 'apache-2.0',
    tier: 'on-device-multimodal-frontier',
    vram_gb_4bit: 2.8,
    vram_gb_bf16: 4.8,
    context_tokens: 131072,
    ...
    architecture_features: ['PLE effective parameters', 'hybrid local/global attention', '128K context', 'native function calling'],
    frontier_student: true,
    benchmarks: {
      verified_at: '2026-06-19',
      ...
      adjacent_metrics: {
        aime_2026_no_tools: 37.5,
        livecodebench_v6: 44.0,
        gpqa_diamond: 43.4,
        tau2_average: 24.5,
        mmmu_pro: 44.2,
        mrcr_v2_8_needle_128k: 19.1,
      },
    },
    notes: 'Apache 2.0 Gemma 4 E2B multimodal edge row. Keep mobile default on Gemma 3n until equivalent phone-runtime proof exists.',
    use_for: ['on-device-multimodal-frontier', 'edge-vision', 'frontier-student'],
  },
  {
    ...
    benchmarks: {
      ...
      adjacent_metrics: {
        aime_2026_no_tools: 42.5,
        livecodebench_v6: 52.0,
        gpqa_diamond: 58.6,
        tau2_average: 42.2,
        mmmu_pro: 52.6,
        mrcr_v2_8_needle_128k: 25.4,
      },
    },
    notes: 'Apache 2.0 Gemma 4 E4B multimodal frontier row for richer edge/laptop vision+audio workloads.',
    use_for: ['multimodal', 'multimodal-frontier', 'edge-vision', 'frontier-student'],
  },
  ...
  },
  {
    ...
    notes: 'Largest Gemma 3 instruction model. Image+text input, 128K context, 140+ language support; use where Gemma-family continuity matters more than Apache-only licensing.',
    use_for: ['vision', 'quality', 'multilingual', 'frontier-open'],
  },
  ...
  // figures reflect the selective-activation footprint, not raw bytes on disk.
  {
    ...
    official_source_url: 'https://ai.google.dev/gemma/docs/gemma-3n',
  ...
  // deployment requires human review + local validation per Google model card.
  {
    ...
    multilingual: false,
    modalities: ['text', 'image'],
    official_source_url: 'https://developers.google.com/health-ai-developer-foundations/medgemma/model-card',
    notes: 'Medical-tuned Gemma 3 4B. Vision+text input, 128K input context, 8192 output tokens. Not for direct clinical decisions; require local eval + clinician review.',
  ...
  },
  {
    ...
    modalities: ['text', 'image'],
    official_source_url: 'https://developers.google.com/health-ai-developer-foundations/medgemma/model-card',
    notes: 'Pretrained (not instruction-tuned). 128K input context, 8192 output tokens. Use as base for domain SFT/LoRA.',
  ...
  },
  {
    ...
    modalities: ['text'],
    official_source_url: 'https://developers.google.com/health-ai-developer-foundations/medgemma/model-card',
    notes: 'Text-only MedGemma. 128K input context, 8192 output tokens. Best benchmark scores in family; A100-40GB+ class.',
  ...
  // (consistent tokenizer; same provider; compact).
  {
    ...
    official_source_url: 'https://ai.google.dev/gemma/docs/embeddinggemma',
...
export const TIER_BY_USE = {
  ...
  edge: 'openbmb/MiniCPM5-1B',
  'edge-agent': 'openbmb/MiniCPM5-1B',
  ...
  // multilingual on-device intake - keep it as the wasm default.
  ...
  multimodal: 'google/gemma-4-E4B-it',
  'multimodal-frontier': 'google/gemma-4-E4B-it',
  'on-device-multimodal-frontier': 'google/gemma-4-E2B-it',
